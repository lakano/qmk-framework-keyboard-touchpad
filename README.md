...
A new connected drive should appear, paste the file .uf2 inside
...
Build the uf2 for classic ANSI layout :
=> qmk compile -kb framework/rp2040 -km ansi

Build the uf2 for classic ISO layout :
=> qmk compile -kb framework/rp2040 -km iso
